...
export default class UI {
    ...
    comprobar(objeto) {
        ...
        this.citas.forEach( cita => {
            if( objeto.fecha === cita.fecha && objeto.horario === cita.horario) {
    ...
    editar(citaActualizada) {
        //El metodo map permite iterar y regresar un arreglo modificado
    ...
    mostrarCitas() {
        ...
        this.citas.forEach(cita => {
            ...
            hora.innerHTML = `<span class="font-bold uppercase">Hora: </span> ${cita.horario}`;
            ...
            btnEditar.onclick = () => {
                cargarEdicion(clone);//Codigo que se ejecuta cuando el usuario da click en editar
            }
